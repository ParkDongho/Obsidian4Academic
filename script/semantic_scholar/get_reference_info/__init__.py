...
def main():
    ...
    parser.add_argument(
        '--reference_info_dir',
        default='/home/parkdongho/dev/Obsidian4Academic/20_Works/21_Research/1_paper_archive/.semantic_graph/reference/',
        help="Directory to write the reference JSON files."
    )
    parser.add_argument(
        '--paper_dir',
    ...
    os.makedirs(args.reference_info_dir, exist_ok=True)

    # Find missing papers or use all papers based on the mode
    missing_papers, all_papers = find_missing_references(args.reference_info_dir, args.paper_dir)
